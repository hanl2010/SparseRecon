...
import numpy as np
# from render_utils import sample_ptsFeatures_from_featureMaps
...
class PatchProjector():
    ...
    def patch_warp(self, pts, uv, normals, src_imgs,
        ...
        sampled_rgb_val = F.grid_sample(src_imgs, grid.view(N_src, -1, 1, 2), align_corners=True).squeeze(
            -1).transpose(1, 2)
        sampled_rgb_val = sampled_rgb_val.view(N_src, N_rays, n_samples, Npx, -1)
        ...
        return sampled_rgb_val, warp_mask_full, grid_original
