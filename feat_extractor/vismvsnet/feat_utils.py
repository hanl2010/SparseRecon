...
class FeatExt(nn.Module):
    ...
    def __init__(self):
        ...
        # print(os.path.abspath("vismvsnet.pt"))
        # feat_ext_dict = {k[16:]: v for k, v in torch.load('models/vismvsnet.pt')['state_dict'].items() if
...
if __name__ == '__main__':
    ...
    images = torch.rand((4, 3, 1200, 1600))
    feat1, feat2, feat3 = feat_ext.forward(images)
    print(feat1.shape)
    print(feat2.shape)
    print(feat3.shape)
